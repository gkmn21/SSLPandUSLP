...
relation_type_mapping = {
  'wkgs:country': 'Country',
  'wkgs:isInCountry': 'Country',
  'wkgs:addrCountry': 'Country',
  'wkgs:addrState': 'State',
  'wkgs:addrSuburb': 'Suburb',
  'wkgs:addrHamlet':  'Hamlet',
  'wkgs:addrProvince': 'Province',
  'wkgs:addrDistrict': 'District',
  'wkgs:isInCounty': 'County',
  'wkgs:capitalCity': 'City',
  'wkgs:isInContinent': 'Continent'
}
